...
private val postureTips = listOf(
    PostureTip(Icons.Outlined.EventSeat, "Sit correctly", "Keep your back supported, shoulders relaxed, and both feet flat on the floor.", NeckWellAccent),
    ...
    PostureTip(Icons.Outlined.FitnessCenter, "Strengthen your core", "A stronger core makes neutral sitting posture easier to maintain.", NeckWellAccent),
        ...
        Column(
            ...
            NeckWellCard {
                Row(
                    ...
                    IconTile(Icons.Outlined.Lightbulb, NeckWellAccent, size = 50)
                    Spacer(Modifier.width(14.dp))
                    Column {
                        Text("Build a posture-friendly day", color = NeckWellTextPrimary, fontSize = 19.sp, fontWeight = FontWeight.Bold)
                        Text("Choose one tip to practice consistently this week.", color = NeckWellTextSecondary, style = MaterialTheme.typography.bodyMedium)
                    }
                }
            }
    ...
    NeckWellCard {
        Row(
            ...
            Column(Modifier.weight(1f)) {
                ...
                Text(tip.title, color = NeckWellTextPrimary, fontSize = 17.sp, fontWeight = FontWeight.Bold)
                Text(tip.description, color = NeckWellTextSecondary, style = MaterialTheme.typography.bodyMedium)
            }
        }
    }
}
